...
<body>
        ...
        <form name="create" action="insert.jsp" method=post onsubmit="return check()">
			...
			<tr>
				...
				<td><input type="file" name="file"><br> <input
					type="submit" value="업로드"></td>
				<form action="Ex01_form.html" method="post"
    ...
    <div>
    		<br>
            <input type=button value="등록"onclick="location.href='template.jsp'"/>
            <input type=submit value="삭제"onclick="location.href='template.jsp'"/>
            <input type=reset value="취소"/>
            <input type=button value="목록" onclick="location.href='template.jsp'"/>
        </div>
        </form>
    </div>    
</body>
