...
public class KanbanBoardAndGroup {
	private String id;
	...
	public String toString() {
		return "KanbanBoardAndGroup [id=" + id + ", kanbanNo=" + kanbanNo + ", kanbanTitle=" + kanbanTitle
				+ ", kanbanContent=" + kanbanContent + ", kanbanDate=" + kanbanDate + ", kanbanFileName="
				+ kanbanFileName + ", kanbanFileSize=" + kanbanFileSize + ", kanbanFileCount=" + kanbanFileCount
				+ ", kanbanCommentCount=" + kanbanCommentCount + ", kanbanCode=" + kanbanCode + ", listName=" + listName
				+ "]";
	}
